 ...
 * @author kairanzhang
 * @Description TODO
 * @createTime 2023年06月30日 20:02:00
 */
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("/Users/kairanzhang/IdeaProjects/bonc/dataservice/open-product-core/src/main/java");
        // 生成注释时的作者
        gc.setAuthor("kairanzhang");
        //生成后是否打开资源管理器
        gc.setOpen(false);
        ...
        pc.setParent("com.bonc.epm.product");
//        pc.setModuleName("entity"); //模块名
//        pc.setController("entity");
        pc.setEntity("entity");
